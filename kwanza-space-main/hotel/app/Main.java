...
public class Main {
    public static void main(String[] args) {
        ...
        Room room101 = new Room(101, RoomType.STANDARD, 25000.0, 2, RoomStatus.ACTIVE);
        Room room102 = new Room(102, RoomType.DELUXE, 25000.0, 2, RoomStatus.ACTIVE);
        Room room201 = new Room(201, RoomType.SUITE, 25000.0, 4, RoomStatus.ACTIVE);
       ...
       //  6. Adicionar serviços adicionais
        ...
        AdditionalService lavandaria = new AdditionalService(
                "LAVANDARIA",
                ServiceType.LAUNDRY,
                2000.0,
                4,
        ...
        //reservation1.addService(lavandaria);
